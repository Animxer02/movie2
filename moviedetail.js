...
const trailerFunction = (id) => {
  return `<iframe class="youtubePlayer" src="https://www.2embed.skin/embedtvfull/tt29467317" width="100%" height="100%" frameborder="0" scrolling="no" allowfullscreen></iframe>`;
};
