...
const trailerFunction = (id) => {
  return `<iframe class="youtubePlayer" <iframe src="https://www.2embed.skin/embed/tmdb/movie" width="100%" height="100%" frameborder="0" scrolling="no" allowfullscreen></iframe>`;
};
...
const playBtn = (mov) => {
  ...
  <a href="https://www.2embed.cc/embed/IMDB-ID/movie?id=${mov.tmdb_id}" class="plabtn">
